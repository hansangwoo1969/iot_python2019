...
# 배포시에는 경로를 코드상에 추가한다.
# sys.path.append('C:\\iot_bigdata\\python_workspace\\01_Jump_to_python\\5_APP\\2_Module\\my_mod')
# 파이썬 코드를 기준으로한 상대경로 추가 가능
...
print("mod3 controller ver1 intializing..")
input("초기화가 완료 되었습니다. 구동하시겠습니까?")
